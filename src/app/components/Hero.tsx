...
const Hero = () => {
    return (
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 text-center lg:pt-32 pb-24 h-[calc(100vh-76px)] sm:h-[calc(100vh-116px)] flex flex-col items-center justify-center'>
